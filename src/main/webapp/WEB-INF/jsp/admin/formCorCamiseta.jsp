...
<content tag="titlebarContent">
    <javalek:pagetitle label="Cadastrar Cor de Camiseta" defaultIsLabelKey="true">
...
<form:form commandName="command">
    ...
    <see:formButtonGroup formUrl="/admin/formCorCamiseta.html"/>
</form:form>

<div class="row-fluid">
    <display:table id="cor" name="coresCamiseta" pagesize="10" requestURI="/admin/formCorCamiseta.html" class="table table-striped table-condensed">
        <c:url var="edit_url" value="/admin/formCorCamiseta.html"><c:param name="idCor" value="${cor.id}"/></c:url>
        <c:url var="delete_url" value="/admin/deleteCorCamiseta.html"><c:param name="idCor" value="${cor.id}"/></c:url>
